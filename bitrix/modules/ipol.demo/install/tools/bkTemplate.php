<?php // $_REQUEST['isFromOpt'] - allows to hide unnecessary barcodes ?>
<style>
.barcode {
  width: 360px;
  min-height: 60px;
...
?>
<div class="barcode" <?php if($_REQUEST['isFromOpt']){?> onclick='this.parentNode.removeChild(this);' <?php }?>>
        <div class="barcode__wrapper">
            ...
            <div class="barcode__block-right">
                <div class="barcode-logotype">
                    <a href="#"><img src="<?=$arBKs['logodemo']?>" alt="logotype"></a>
                </div>
                <ul class="barcode-catalogue">
                    ...
                    <li class="barcode__list-type"><a href="#" class="barcode__descr">demo</a></li>
        ...
        <div class="barcode__marker">
            <img src='<?=$arBKs['path']?>?<?=$arBKs['actionName']?>=getBarcode&barcode=<?=$arBK['DEMO_ID']?>' alt="barcode-marker"/>
			<div class="barcode-symbol"><?=$arBK['DEMO_ID']?></div>
        </div>
    </div>
