...
class GoodsPicker
{
     ...
     */
    protected static $complectsBlocker = 'IPOL_DEMO_DOWNCOMPLECTS';

    /**
     * @var string if constant defined, CAN_BUY check skipped when receiving basket goods
     */
    protected static $ignoreCanBuy = 'IPOL_DEMO_IGNORECANBUY';
    ...
    protected static function callOnItemsListReady(&$goods)
    {
        ...
        $event = new Event(IPOL_DEMO, "onItemsListReady", ['ITEMS' => $goods]);
        $event->send();
