<?php
namespace Ipol\Demo\Bitrix\Handler;
...
use \Ipol\Demo\CargoHandler;
use \Ipol\Demo\PointsHandler;
use \Ipol\Demo\ProfileHandler;
use \Ipol\Demo\Bitrix\Tools;
use \Ipol\Demo\Bitrix\Controller\Calculator;
 ...
 * @package namespace Ipol\Demo\Bitrix\Handler
 */
class DeliveryHandlerPickup extends \Bitrix\Sale\Delivery\Services\Base
{
    ...
    /**
     * @var bool|\Ipol\Demo\Bitrix\Controller\Calculator
     */
     ...
     *
     * @param string $guid Demo point guid
     */
        ...
        try
        {
            if (empty($this->calculator)) {
				...
				$this->calculator->setTariffDependency(ProfileHandler::profilesToCalculator())
					->setPayment(CargoHandler::definePaysystem())
            ...
            $event = new Event(IPOL_DEMO, "onCompabilityBefore", array(
    ...
    protected function calculateConcrete(Shipment $shipment = null)
    {
        ...
        try
        {
            ...
            */
            ...
            $event = new Event(IPOL_DEMO, "onCalculate", array(
                'DELIVERY_ID' => $this->getId(),
                'SHIPMENT'    => $shipment,
    ...
    protected function checkRequiredData(Shipment $shipment)
    {
        ...
        if (!(\Ipol\Demo\authHandler::isAuthorized()))
        {
