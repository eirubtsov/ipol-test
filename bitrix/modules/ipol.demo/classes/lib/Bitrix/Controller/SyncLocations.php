...
class SyncLocations extends AbstractController
{
    ...
    public function getLocations()
    {
        ...
        $existedLocationsDB = \Ipol\Demo\LocationDadataTable::getList(['select' => ['LOCALITY_FIAS_CODE' => 'DEMO_FIAS_GUID', 'BITRIX_CODE'], 'filter' => ['!=BITRIX_CODE' => '-'], 'order' => ['ID' => 'ASC']]);
        while ($tmp = $existedLocationsDB->fetch())
        {
    ...
    {
        $handle = curl_init();
        curl_setopt($handle, CURLOPT_URL, 'https://ipol.ru/webService/demo/locations.json');
