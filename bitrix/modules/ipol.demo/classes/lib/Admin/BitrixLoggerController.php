...
use Ipol\Demo\Api\Logger\FileRoute;
 ...
 */
class BitrixLoggerController extends \Ipol\Demo\Api\Logger\Logger
{
    /**
     * @var array
     */
    ...
    public function __construct(string $name = 'common_log')
    {
        ...
        try {
            $arrOpt = Option::getForModule(IPOL_DEMO);
    ...
    {
        return DIRECTORY_SEPARATOR.implode(DIRECTORY_SEPARATOR, ['bitrix', 'tools', IPOL_DEMO, 'logs']).DIRECTORY_SEPARATOR;
    }
