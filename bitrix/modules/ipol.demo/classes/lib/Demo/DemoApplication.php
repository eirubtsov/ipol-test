...
use Ipol\Demo\Api\Logger\Psr\Log\LoggerInterface;
use Ipol\Demo\Api\Sdk;
...
use Ipol\Demo\Demo\Controller\AutomatedCommonRequest;
use Ipol\Demo\Demo\Controller\AutomatedCommonRequestByUuid;
use Ipol\Demo\Demo\Controller\CancelOrderByNumber;
use Ipol\Demo\Demo\Controller\CancelOrderByUuid;
use Ipol\Demo\Demo\Controller\Order;
use Ipol\Demo\Demo\Controller\OrderLabels;
use Ipol\Demo\Demo\Controller\OrdersMake;
use Ipol\Demo\Demo\Controller\OrderHistoryController;
use Ipol\Demo\Demo\Controller\OrderStatusController;
use Ipol\Demo\Demo\Controller\PickupPoints;
use Ipol\Demo\Demo\Controller\RequestController;
use Ipol\Demo\Demo\Controller\RequestJwt;
use Ipol\Demo\Demo\Controller\Warehouse;
use Ipol\Demo\Demo\Controller\WarehousesInfo;
use Ipol\Demo\Demo\Entity\AbstractResult;
use Ipol\Demo\Demo\Entity\GenerateBarcodeResult;
use Ipol\Demo\Demo\Handler\Tools;
...
class DemoApplication
{
     ...
     */
    public function setJwt(string $jwt): DemoApplication
    {
        $this->jwt = $jwt;
        return $this;
    }
     ...
     * @return Collection of \Ipol\Demo\Api\Entity\Response\Part\PickupPoint\Content
     */
    ...
    /**
     * @param string $uuid - order uuid from demo API
     ...
     * @param string $type - "uuid" if arNumbers has demo api uuids of orders
     ...
     * @param string $type - "uuid" if id is demo api uuid of order
     ...
     * @param string $type - DemoApplication::ORDER_ID_TYPE_5P - $orderNumbers are Demo API uuids
     *                       DemoApplication::ORDER_ID_TYPE_CMS - $orderNumbers are CMS order numbers
     ...
     */
    public function generateBarcode($uniqueItemCode = null): GenerateBarcodeResult
    {
        try {
            return Tools::barcodeGenerate($this->getOptions(), $uniqueItemCode);
        } catch (Exception $e) {
            $this->addError($e);
     ...
     * @return DemoApplication
     */
    public function setApiKey(string $apiKey): DemoApplication
    {
        $this->apiKey = $apiKey;
        return $this;
    }
     ...
     * @return DemoApplication
     */
    public function setTestMode(bool $testMode): DemoApplication
    {
     ...
     * @return $this
     */
    public function allowCustom(): DemoApplication
    {
     ...
     * @return $this
     */
    public function disallowCustom(): DemoApplication
    {
     ...
     * @return DemoApplication
     */
    public function setEncoder($encoder): DemoApplication
    {
     ...
     * @return DemoApplication
     */
    public function setLogger($logger): DemoApplication
    {
        $this->logger = $logger;
        return $this;
    }
     ...
     * @return DemoApplication
     */
    public function setOptions(OptionsInterface $options): DemoApplication
    {
     ...
     * @return DemoApplication
     */
    public function setTimeout($timeout): DemoApplication
    {
     ...
     * @return DemoApplication
     */
    public function setCache($cache): DemoApplication
    {
        $this->cache = $cache;
        return $this;
    }
     ...
     * @return DemoApplication
     */
    public function toCache($data, int $ttl = 3600, string $hash = ""): DemoApplication
    {
        if(!$hash)
            $hash = $this->getHash();
     ...
     * @return DemoApplication
     */
    public function setAbyss($abyss): DemoApplication
    {
        $this->abyss = $abyss;
        return $this;
    }
     ...
     * @return DemoApplication
     */
    public function setAbyssLock(bool $blockAbyss): DemoApplication
    {
     ...
     */
    public function toAbyss($val, $hash = false): DemoApplication
    {
        $hash = ($hash)? $hash : $this->getHash();
     ...
     * @return DemoApplication
     */
    public function setHash($hash): DemoApplication
    {
        $this->hash = $hash;
        return $this;
    }
     ...
     * @return $this
     */
    protected function addError($error): DemoApplication
    {
