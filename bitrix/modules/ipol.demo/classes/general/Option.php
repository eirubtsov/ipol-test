...
use Ipol\Demo\Bitrix\Handler\Statuses;
...
class Option extends AbstractGeneral
{
    ...
    public static function collection()
    {
        if (self::$collection) {
            ...
            // name - always IPOL_DEMO_OPT_<code>
            $arOptions = array(
                // auth
                'apikey' => array(
                    //'group' => 'auth',
    ...
    public static function validate($code, $val)
    {
        ...
        if (array_key_exists('required', $optDescr) && $optDescr['required'] && !$val) {
            $result->setSuccess(false)->setErrorText(\Ipol\Demo\Bitrix\Tools::getMessage('ERROR_OPTSAVE_UNGIVEN'));
        }
