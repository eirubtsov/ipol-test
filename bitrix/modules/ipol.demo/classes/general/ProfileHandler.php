...
class ProfileHandler extends AbstractGeneral
{
    ...
    public static function getProfiles()
    {
        $arProfiles = array(
            'pickup' => array(
                ...
                'ClassName'      => '\Ipol\Demo\Bitrix\Handler\DeliveryHandlerPickup',
    ...
    {
        $path = implode(DIRECTORY_SEPARATOR, [$_SERVER['DOCUMENT_ROOT'], 'bitrix', 'images', IPOL_DEMO, $profile.'.png']);
        if (file_exists($path))
        {
